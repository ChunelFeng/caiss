...
const static std::string WORD = "nominations";
const static ANN_SEARCH_TYPE searchType = ANN_SEARCH_WORD;
...
int train() {
    ...
    ret = proc->train(TEST_FILE_PATH.data(), 100000, 0, 0, 1,1,1,1,1);
    ANN_FUNCTION_CHECK_STATUS
