...
public:
    ...
    virtual ANN_RET_TYPE init(void *handle, const ANN_MODE mode, const ANN_DISTANCE_TYPE distanceType, const unsigned int dim, const char *modelPath,
    ...
    virtual ANN_RET_TYPE getResult(void *handle, char *result, const unsigned int size) = 0;
